...
<body>
    <div class="container">
        <div class="header">
            <div class="logo">
                <img src="https://www.agrivoltdrone.com/img/AgriVolt_logo_oficial.png" alt="AgriVolt" style="height: 40px; width: auto; margin-bottom: 10px;">
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="text-align: center; margin-top: 25px;">
                <a href="https://www.agrivoltdrone.com" class="cta-button">🌐 Visitar nuestro sitio web</a>
            </div>
        </div>
